...
TECH_TABLES = [
    ...
    "[AOI_&_AXI_V9i]",
    "[Camalot_Prodigy]",
    "[Conveyor_LoaderUnloader]",
    "[Conveyor_BufferSeires]",
    "[Conveyor_ConveyorSeries]",
    "[Conveyor_LinkWorkSeries]",
    "[Conveyor_PCControlledSeries]",
    "[P&P_-_Pick_and_Place_CNTAIMEXIII25ECamera]",
    "[P&P_-_Pick_and_Place_CNTAIMEXIII25EITEM]",
    "[P&P_-_Pick_and_Place_CNTNXTRS12E]",
    "[P&P_-_Pick_and_Place_CNTNXTRS12ECamera]",
    "[P&P_-_Pick_and_Place_SpecsNXTIII]",
    "[P&P_-_Pick_and_Place_SpecsNXTIIICamera]",
    "[Proposal_1_7_AIMEX_III]",
    "[Proposal_2_8_NXT]",
    "[Proposal_3_12_NXT]",
    "[Proposal_4_16_NXT]",
    "[RFO_-_Reflow_Oven_Centurion]",
    "[SC_-_Screen_Printer_ASMDEKNeoJabiliX]",
    "[SC_-_Screen_Printer_BrochureScreenPrintersJuki]",
    "[SC_-_Screen_Printer_CNTGPXCL09E]",
    "[SC_-_Screen_Printer_MPMPrinterFamily]",
    "[SC_-_Screen_Printer_SERIO8000DS160819CCDE]",
    "[SPI_KohYoung8030]",
    "[SPI_KohYoungMachineSpecificationCamaraComparison]",
]
